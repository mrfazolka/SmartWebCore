<?php
// source: C:\xampp\htdocs\hovno\app/config/config.neon 
// source: C:\xampp\htdocs\hovno\app/config/config.local.neon 

class Container_e4e996c56b extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\hovno\app',
			'wwwDir' => 'C:\xampp\htdocs\hovno\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\hovno\app/../temp',
			'thumbnail' => array(
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\hovno\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\hovno\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\hovno\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_e4e996c56b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\hovno\app/../temp/cache/latte');
	...
	{
		$service = new Kollarovic\Thumbnail\Generator('C:\xampp\htdocs\hovno\www', $this->getService('http.request'), 'images/thumbs/{width}x{height}/{filename}-{width}x{height}.{extension}',
			'http://path/images/noimg.jpg');
		return $service;
	}
...
final class Container_e4e996c56b_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e4e996c56b $container)
	{
