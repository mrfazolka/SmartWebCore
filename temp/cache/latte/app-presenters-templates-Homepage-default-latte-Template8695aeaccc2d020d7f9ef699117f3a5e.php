<?php
// source: C:\xampp\htdocs\SmartWebCore\app\presenters/templates/Homepage/default.latte

class Template8695aeaccc2d020d7f9ef699117f3a5e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7910371715', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb9c5a05be1b_content')) { function _lb9c5a05be1b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
<div id="content">
	...
	<h3><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link("Sign:in"), ENT_COMPAT) ?>
">Log in</a> and try <b>Smart component</b> :)</h3>
	<i>(login: 'admin', pass: 'admin')</i>
<?php $_l->tmp = $_control->getComponent("textCmp-test_Id1"); $_l->tmp->staticParams=array(); if ($_l->tmp instanceof Nette\Application\UI\IRenderable) $_l->tmp->redrawControl(NULL, FALSE); $_l->tmp->render() ?>
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb401def49b7_title')) { function _lb401def49b7_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb7e75e7c8bb_scripts')) { function _lb7e75e7c8bb_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb1ffff6f7ac_head')) { function _lb1ffff6f7ac_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
