<?php
// source: C:\xampp\htdocs\hovno\app\presenters/templates/@layout.latte

class Templatef099aa5d59717a579b7f30209e3a6c2e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9f573e4581', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbafdb940d82_head')) { function _lbafdb940d82_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb2eeed02db0_scripts')) { function _lb2eeed02db0_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
